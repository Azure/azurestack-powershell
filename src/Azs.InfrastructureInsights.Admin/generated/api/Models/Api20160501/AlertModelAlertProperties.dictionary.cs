namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Models.Api20160501
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IAssociativeArray<string>
    {
        ...
        global::System.Collections.Generic.IDictionary<global::System.String,string> Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IAssociativeArray<string>.AdditionalProperties { get => __additionalProperties; }

        int Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IAssociativeArray<string>.Count { get => __additionalProperties.Count; }

        global::System.Collections.Generic.IEnumerable<global::System.String> Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IAssociativeArray<string>.Keys { get => __additionalProperties.Keys; }

        global::System.Collections.Generic.IEnumerable<string> Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IAssociativeArray<string>.Values { get => __additionalProperties.Values; }
        ...
        public void CopyFrom(global::System.Collections.IDictionary source)
        {
            if (null != source)
            {
                foreach( var property in  Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.PowerShell.TypeConverterExtensions.GetFilteredProperties(source, new global::System.Collections.Generic.HashSet<global::System.String>() {  } ) )
                {
        ...
        public static implicit operator global::System.Collections.Generic.Dictionary<global::System.String,string>(Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Models.Api20160501.AlertModelAlertProperties source) => source.__additionalProperties;
    }
}