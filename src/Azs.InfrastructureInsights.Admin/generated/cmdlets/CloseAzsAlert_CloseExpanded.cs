...
namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Close, @"AzsAlert_CloseExpanded", SupportsShouldProcess = true)]
    ...
    public partial class CloseAzsAlert_CloseExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IEventListener
    {
        ...
        SerializedName = @"location",
        PossibleTypes = new [] { typeof(string) })]
        public string Location1 { get => AlertBody.Location ?? null; set => AlertBody.Location = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="CloseAzsAlert_CloseExpanded" /> cmdlet class.
        /// </summary>
        public CloseAzsAlert_CloseExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AlertsClose(SubscriptionId, ResourceGroupName, Location, Name, User, AlertBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Location=Location,Name=Name,User=User,body=AlertBody})
                    {
