...
namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Close, @"AzsAlert_CloseViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class CloseAzsAlert_CloseViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="CloseAzsAlert_CloseViaIdentity" /> cmdlet class.
        /// </summary>
        public CloseAzsAlert_CloseViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AlertsCloseViaIdentity(InputObject.Id, User, Alert, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AlertsClose(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Location ?? null, InputObject.AlertName ?? null, User, Alert, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  User=User,body=Alert})
                    {
