...
namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/alerts/{alertName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsAlert_Get")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Description(@"Returns the requested an alert.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Generated]
    public partial class GetAzsAlert_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Intializes a new instance of the <see cref="GetAzsAlert_Get" /> cmdlet class.</summary>
        public GetAzsAlert_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.AlertsGet(SubscriptionId, ResourceGroupName, Location, Name, onOk, this, Pipeline);
