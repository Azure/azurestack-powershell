...
namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Repair=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.InfrastructureInsights.Admin/regionHealths/{location}/alerts/{alertName}/repair"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Repair, @"AzsAlert_Repair", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Description(@"Repairs an alert.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Generated]
    public partial class RepairAzsAlert_Repair : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the alert.")]
        [Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("AlertName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.ParameterCategory.Path)]
        ...
        /// <returns>a duplicate instance of RepairAzsAlert_Repair</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Cmdlets.RepairAzsAlert_Repair Clone()
        {
            var clone = new RepairAzsAlert_Repair();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.Events.DelayBeforePolling:
                    {
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            ...
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'AlertsRepair' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.AlertsRepair(SubscriptionId, ResourceGroupName, Location, Name, onOk, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RepairAzsAlert_Repair" /> cmdlet class.
        /// </summary>
        public RepairAzsAlert_Repair()
        {
