...
using Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.InfrastructureInsightsAdmin.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
