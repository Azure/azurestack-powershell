# How-To
This document describes how to develop for `Azs.Infrastructureinsights.Admin`.

## Building `Azs.Infrastructureinsights.Admin`
...
## Testing `Azs.Infrastructureinsights.Admin`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `Azs.Infrastructureinsights.Admin` into the session.
