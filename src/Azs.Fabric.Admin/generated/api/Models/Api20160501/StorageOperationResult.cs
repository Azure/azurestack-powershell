namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501
{
    ...
    public partial class StorageOperationResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultInternal,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IValidates
    {
        ...
        public string[] Instance { get => ((Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModelInternal)Property).Instance; set => ((Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModelInternal)Property).Instance = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModel Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultInternal.Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.StorageOperationResultModel()); set { {_property = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModel _property;

        /// <summary>Storage operation result properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Origin(Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModel Property { get => (this._property = this._property ?? new Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.StorageOperationResultModel()); set => this._property = value; }

        /// <summary>Success or failure of operation.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Origin(Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.PropertyOrigin.Inlined)]
        public string ProvisioningState { get => ((Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModelInternal)Property).ProvisioningState; set => ((Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModelInternal)Property).ProvisioningState = value ?? null; }
        ...
        /// <summary>Creates an new <see cref="StorageOperationResult" /> instance.</summary>
    ...
    /// Storage operation result description.
    internal partial interface IStorageOperationResultInternal :
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IResourceInternal
    {
        /// <summary>List of operation result instances.</summary>
        string[] Instance { get; set; }
        /// <summary>Storage operation result properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IStorageOperationResultModel Property { get; set; }
        /// <summary>Success or failure of operation.</summary>
        string ProvisioningState { get; set; }
