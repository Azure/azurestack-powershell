...
using Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
