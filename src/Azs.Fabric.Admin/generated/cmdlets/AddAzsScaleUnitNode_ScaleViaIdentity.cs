...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzsScaleUnitNode_ScaleViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzsScaleUnitNode_ScaleViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ScaleUnitNodeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IScaleOutScaleUnitParametersList _scaleUnitNodeParameter;

        /// <summary>A list of input data that allows for adding a set of scale unit nodes.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A list of input data that allows for adding a set of scale unit nodes.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"A list of input data that allows for adding a set of scale unit nodes.",
        SerializedName = @"scaleUnitNodeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IScaleOutScaleUnitParametersList) })]
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IScaleOutScaleUnitParametersList ScaleUnitNodeParameter { get => this._scaleUnitNodeParameter; set => this._scaleUnitNodeParameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzsScaleUnitNode_ScaleViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzsScaleUnitNode_ScaleViaIdentity()
        {
        ...
        /// <returns>a duplicate instance of AddAzsScaleUnitNode_ScaleViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.AddAzsScaleUnitNode_ScaleViaIdentity Clone()
        {
            var clone = new AddAzsScaleUnitNode_ScaleViaIdentity();
            ...
            clone.ScaleUnitNodeParameter = this.ScaleUnitNodeParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScaleUnitsScaleOutViaIdentity(InputObject.Id, ScaleUnitNodeParameter, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScaleUnitsScaleOut(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Location ?? null, InputObject.ScaleUnit ?? null, ScaleUnitNodeParameter, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ScaleUnitNodeParameter})
                    {
