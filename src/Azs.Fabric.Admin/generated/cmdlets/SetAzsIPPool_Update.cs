...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzsIPPool_Update", SupportsShouldProcess = true)]
    ...
    public partial class SetAzsIPPool_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IIPPool _pool;

        /// <summary>
        /// This resource defines the range of IP addresses from which addresses are allocated for nodes within a subnet.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "This resource defines the range of IP addresses from which addresses are allocated for nodes within a subnet.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IIPPool Pool { get => this._pool; set => this._pool = value; }
        ...
        /// <returns>a duplicate instance of SetAzsIPPool_Update</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.SetAzsIPPool_Update Clone()
        {
            var clone = new SetAzsIPPool_Update();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.IPPoolsCreateOrUpdate(SubscriptionId, ResourceGroupName, Location, Name, Pool, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Location=Location,Name=Name,body=Pool})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzsIPPool_Update" /> cmdlet class.
        /// </summary>
        public SetAzsIPPool_Update()
        {
