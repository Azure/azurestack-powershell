...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsStorageOperationResult_Get")]
    ...
    public partial class GetAzsStorageOperationResult_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzsStorageOperationResult_Get" /> cmdlet class.
        /// </summary>
        public GetAzsStorageOperationResult_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.StorageOperationResultsGet(SubscriptionId, ResourceGroupName, Location, Operation, onOk, onNotFound, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,Location=Location,Operation=Operation})
                    {
