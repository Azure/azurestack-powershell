...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Repair=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/scaleUnitNodes/{scaleUnitNode}/Repair"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Repair, @"AzsScaleUnitNode_RepairViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Description(@"Repairs a node of the cluster.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Generated]
    public partial class RepairAzsScaleUnitNode_RepairViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BareMetalNodeBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IBareMetalNodeDescription _bareMetalNodeBody= new Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.BareMetalNodeDescription();

        /// <summary>Description of a bare metal node used for ScaleOut operation on a cluster.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IBareMetalNodeDescription BareMetalNodeBody { get => this._bareMetalNodeBody; set => this._bareMetalNodeBody = value; }

        /// <summary>Bios version of the physical machine.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Bios version of the physical machine.")]
        ...
        public string BiosVersion { get => BareMetalNodeBody.BiosVersion ?? null; set => BareMetalNodeBody.BiosVersion = value; }

        /// <summary>BMC address of the physical machine.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "BMC address of the physical machine.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string BmciPv4Address { get => BareMetalNodeBody.BmciPv4Address ?? null; set => BareMetalNodeBody.BmciPv4Address = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the cluster.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ClusterName { get => BareMetalNodeBody.ClusterName ?? null; set => BareMetalNodeBody.ClusterName = value; }

        /// <summary>Name of the computer.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the computer.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ComputerName { get => BareMetalNodeBody.ComputerName ?? null; set => BareMetalNodeBody.ComputerName = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.IFabricAdminIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.IFabricAdminIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }

        /// <summary>Accessor for our copy of the InvocationInfo.</summary>
        public global::System.Management.Automation.InvocationInfo InvocationInformation { get => __invocationInfo = __invocationInfo ?? this.MyInvocation ; set { __invocationInfo = value; } }

        /// <summary>Name of the MAC address of the bare metal node.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Name of the MAC address of the bare metal node.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MacAddress { get => BareMetalNodeBody.MacAddress ?? null; set => BareMetalNodeBody.MacAddress = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Model of the physical machine.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Model { get => BareMetalNodeBody.Model ?? null; set => BareMetalNodeBody.Model = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Serial number of the physical machine.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SerialNumber { get => BareMetalNodeBody.SerialNumber ?? null; set => BareMetalNodeBody.SerialNumber = value; }

        /// <summary>Vendor of the physical machine.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Vendor of the physical machine.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Vendor { get => BareMetalNodeBody.Vendor ?? null; set => BareMetalNodeBody.Vendor = value; }
        ...
        /// <returns>a duplicate instance of RepairAzsScaleUnitNode_RepairViaIdentityExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.RepairAzsScaleUnitNode_RepairViaIdentityExpanded Clone()
        {
            var clone = new RepairAzsScaleUnitNode_RepairViaIdentityExpanded();
            ...
            clone.BareMetalNodeBody = this.BareMetalNodeBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScaleUnitNodesRepair' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScaleUnitNodesRepairViaIdentity(InputObject.Id, BareMetalNodeBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.ScaleUnitNode)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.ScaleUnitNode"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.ScaleUnitNodesRepair(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Location ?? null, InputObject.ScaleUnitNode ?? null, BareMetalNodeBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalNodeBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RepairAzsScaleUnitNode_RepairViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public RepairAzsScaleUnitNode_RepairViaIdentityExpanded()
        {
