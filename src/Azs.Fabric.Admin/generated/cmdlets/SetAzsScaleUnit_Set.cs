...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Set, @"AzsScaleUnit_Set", SupportsShouldProcess = true)]
    ...
    public partial class SetAzsScaleUnit_Set : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="GpuPartitionSizeParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.ISetGpuPartitionSizeParameter _gpuPartitionSizeParameter;

        /// <summary>Input data for setting GPU partitions.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Input data for setting GPU partitions.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Input data for setting GPU partitions.",
        SerializedName = @"gpuPartitionSizeParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.ISetGpuPartitionSizeParameter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.ISetGpuPartitionSizeParameter GpuPartitionSizeParameter { get => this._gpuPartitionSizeParameter; set => this._gpuPartitionSizeParameter = value; }
        ...
        /// <returns>a duplicate instance of SetAzsScaleUnit_Set</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.SetAzsScaleUnit_Set Clone()
        {
            var clone = new SetAzsScaleUnit_Set();
            ...
            clone.GpuPartitionSizeParameter = this.GpuPartitionSizeParameter;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScaleUnitsSetGpuPartitionSize(SubscriptionId, ResourceGroupName, Location, Name, GpuPartitionSizeParameter, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="SetAzsScaleUnit_Set" /> cmdlet class.
        /// </summary>
        public SetAzsScaleUnit_Set()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IExtendedErrorInfo> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, Location=Location, Name=Name, body=GpuPartitionSizeParameter })
                    {
