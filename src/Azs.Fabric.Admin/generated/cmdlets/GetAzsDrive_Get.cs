...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsDrive_Get")]
    ...
    public partial class GetAzsDrive_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the storage drive.")]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Intializes a new instance of the <see cref="GetAzsDrive_Get" /> cmdlet class.</summary>
        public GetAzsDrive_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DrivesGet(SubscriptionId, ResourceGroupName, Location, ScaleUnit, StorageSubSystem, Name, onOk, onNotFound, this, Pipeline);
