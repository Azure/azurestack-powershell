...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Repair, @"AzsScaleUnitNode_RepairViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RepairAzsScaleUnitNode_RepairViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="BareMetalNode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IBareMetalNodeDescription _bareMetalNode;

        /// <summary>Description of a bare metal node used for ScaleOut operation on a cluster.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Description of a bare metal node used for ScaleOut operation on a cluster.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Description of a bare metal node used for ScaleOut operation on a cluster.",
        SerializedName = @"bareMetalNode",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IBareMetalNodeDescription) })]
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IBareMetalNodeDescription BareMetalNode { get => this._bareMetalNode; set => this._bareMetalNode = value; }
        ...
        /// <returns>a duplicate instance of RepairAzsScaleUnitNode_RepairViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.RepairAzsScaleUnitNode_RepairViaIdentity Clone()
        {
            var clone = new RepairAzsScaleUnitNode_RepairViaIdentity();
            ...
            clone.BareMetalNode = this.BareMetalNode;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ScaleUnitNodesRepairViaIdentity(InputObject.Id, BareMetalNode, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ScaleUnitNodesRepair(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.Location ?? null, InputObject.ScaleUnitNode ?? null, BareMetalNode, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=BareMetalNode})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RepairAzsScaleUnitNode_RepairViaIdentity" /> cmdlet class.
        /// </summary>
        public RepairAzsScaleUnitNode_RepairViaIdentity()
        {
