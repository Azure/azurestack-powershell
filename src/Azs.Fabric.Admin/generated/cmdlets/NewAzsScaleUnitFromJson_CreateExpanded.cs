...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateFromJson=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Fabric.Admin/fabricLocations/{location}/scaleUnits/{scaleUnit}/createFromJson"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzsScaleUnitFromJson_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Description(@"Add a new scale unit.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Generated]
    public partial class NewAzsScaleUnitFromJson_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Cluster name for the new scale unit.")]
        ...
        public string ClusterName { get => CreationDataBody.ClusterName ?? null; set => CreationDataBody.ClusterName = value; }

        /// <summary>Backing field for <see cref="CreationDataBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.ICreateFromJsonScaleUnitParametersList _creationDataBody= new Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.CreateFromJsonScaleUnitParametersList();

        /// <summary>A list of input data that allows for creating the new scale unit.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.ICreateFromJsonScaleUnitParametersList CreationDataBody { get => this._creationDataBody; set => this._creationDataBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The subnet IP mask in the example format 10.0.0.0/25.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] InfrastructureNetworkSubnet { get => CreationDataBody.InfrastructureNetworkSubnet ?? null /* arrayOf */; set => CreationDataBody.InfrastructureNetworkSubnet = value; }

        /// <summary>The Vlan ID of the subnet.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The Vlan ID of the subnet.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] InfrastructureNetworkVlanId { get => CreationDataBody.InfrastructureNetworkVlanId ?? null /* arrayOf */; set => CreationDataBody.InfrastructureNetworkVlanId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The network QOS priority setting.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public int NetQosPriority { get => CreationDataBody.NetQosPriority ?? default(int); set => CreationDataBody.NetQosPriority = value; }
        ...
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "List of nodes in the scale unit.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20201001.IDeploymentJsonPhysicalNodeParameters[] PhysicalNode { get => CreationDataBody.PhysicalNode ?? null /* arrayOf */; set => CreationDataBody.PhysicalNode = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The software ASN for the cluster's rack.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SoftwareBgpAsn { get => CreationDataBody.SoftwareBgpAsn ?? null; set => CreationDataBody.SoftwareBgpAsn = value; }
        ...
        SerializedName = @"subnet",
        PossibleTypes = new [] { typeof(string) })]
        public string[] StorageNetworkSubnet { get => CreationDataBody.StorageNetworkSubnet ?? null /* arrayOf */; set => CreationDataBody.StorageNetworkSubnet = value; }
        ...
        SerializedName = @"vlanId",
        PossibleTypes = new [] { typeof(string) })]
        public string[] StorageNetworkVlanId { get => CreationDataBody.StorageNetworkVlanId ?? null /* arrayOf */; set => CreationDataBody.StorageNetworkVlanId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ASN for the cluster's rack TOR.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string TorSwitchBgpAsn { get => CreationDataBody.TorSwitchBgpAsn ?? null; set => CreationDataBody.TorSwitchBgpAsn = value; }

        /// <summary>The list of IP addresses used for TOR communication.</summary>
        [global::System.Management.Automation.AllowEmptyCollection]
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The list of IP addresses used for TOR communication.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] TorSwitchBgpPeerIP { get => CreationDataBody.TorSwitchBgpPeerIP ?? null /* arrayOf */; set => CreationDataBody.TorSwitchBgpPeerIP = value; }
        ...
        /// <returns>a duplicate instance of NewAzsScaleUnitFromJson_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets.NewAzsScaleUnitFromJson_CreateExpanded Clone()
        {
            var clone = new NewAzsScaleUnitFromJson_CreateExpanded();
            ...
            clone.CreationDataBody = this.CreationDataBody;
            clone.SubscriptionId = this.SubscriptionId;
            clone.ResourceGroupName = this.ResourceGroupName;
            clone.Location = this.Location;
            clone.ScaleUnit = this.ScaleUnit;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzsScaleUnitFromJson_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzsScaleUnitFromJson_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ScaleUnitsCreateFromJson' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ScaleUnitsCreateFromJson(SubscriptionId, ResourceGroupName, Location, ScaleUnit, CreationDataBody, onOk, this, Pipeline);
