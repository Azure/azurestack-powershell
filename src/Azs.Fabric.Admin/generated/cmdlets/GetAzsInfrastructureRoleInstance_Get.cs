...
namespace Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsInfrastructureRoleInstance_Get")]
    ...
    public partial class GetAzsInfrastructureRoleInstance_Get : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of an infrastructure role instance.")]
        [Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzsInfrastructureRoleInstance_Get" /> cmdlet class.
        /// </summary>
        public GetAzsInfrastructureRoleInstance_Get()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.InfraRoleInstancesGet(SubscriptionId, ResourceGroupName, Location, Name, onOk, onNotFound, this, Pipeline);
