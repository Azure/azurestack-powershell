...
.Link
https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsinfrastructurelocation
#>
function Get-AzsInfrastructureLocation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IFabricLocation])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Azs.Fabric.Admin.private\Get-AzsInfrastructureLocation_Get';
            GetViaIdentity = 'Azs.Fabric.Admin.private\Get-AzsInfrastructureLocation_GetViaIdentity';
            List = 'Azs.Fabric.Admin.private\Get-AzsInfrastructureLocation_List';
        }
