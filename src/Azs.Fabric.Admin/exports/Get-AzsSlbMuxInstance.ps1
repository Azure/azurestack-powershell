...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsSlbMuxInstance';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsSlbMuxInstance';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsSlbMuxInstance';
        }
