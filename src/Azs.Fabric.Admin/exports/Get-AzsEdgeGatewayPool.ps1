...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGatewayPool';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGatewayPool';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGatewayPool';
        }
