...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsMacAddressPool';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsMacAddressPool';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsMacAddressPool';
        }
