...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRole';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRole';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRole';
        }
