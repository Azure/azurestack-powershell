...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGateway';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGateway';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsEdgeGateway';
        }
