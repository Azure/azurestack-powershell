...
begin {
    try {
        ...
        $mapping = @{
            PowerOff = 'Azs.Fabric.Admin.custom\Stop-AzsScaleUnitNode';
            Shutdown = 'Azs.Fabric.Admin.custom\Stop-AzsScaleUnitNode';
            ShutdownViaIdentity = 'Azs.Fabric.Admin.custom\Stop-AzsScaleUnitNode';
            PowerOffViaIdentity = 'Azs.Fabric.Admin.custom\Stop-AzsScaleUnitNode';
        }
