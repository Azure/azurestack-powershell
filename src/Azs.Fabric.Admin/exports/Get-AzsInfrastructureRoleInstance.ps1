...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRoleInstance';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRoleInstance';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureRoleInstance';
        }
