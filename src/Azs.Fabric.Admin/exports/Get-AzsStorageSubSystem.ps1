...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsStorageSubSystem';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsStorageSubSystem';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsStorageSubSystem';
        }
