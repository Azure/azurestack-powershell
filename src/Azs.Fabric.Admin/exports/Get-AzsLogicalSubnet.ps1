...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsLogicalSubnet';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsLogicalSubnet';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsLogicalSubnet';
        }
