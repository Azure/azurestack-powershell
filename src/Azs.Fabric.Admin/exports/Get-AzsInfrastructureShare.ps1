...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureShare';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureShare';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsInfrastructureShare';
        }
