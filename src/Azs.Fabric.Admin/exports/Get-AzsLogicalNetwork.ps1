...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsLogicalNetwork';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsLogicalNetwork';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsLogicalNetwork';
        }
