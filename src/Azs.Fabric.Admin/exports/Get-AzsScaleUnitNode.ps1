...
begin {
    try {
        ...
        $mapping = @{
            List = 'Azs.Fabric.Admin.custom\Get-AzsScaleUnitNode';
            Get = 'Azs.Fabric.Admin.custom\Get-AzsScaleUnitNode';
            GetViaIdentity = 'Azs.Fabric.Admin.custom\Get-AzsScaleUnitNode';
        }
