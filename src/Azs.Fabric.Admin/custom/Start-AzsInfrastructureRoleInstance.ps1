...
Power on an infrastructure role instance.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/start-azsinfrastructureroleinstance
.Inputs
