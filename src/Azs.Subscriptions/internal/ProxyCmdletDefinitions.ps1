...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Delete = 'Azs.Subscriptions.private\Remove-AzsSubscription_Delete';
            DeleteViaIdentity = 'Azs.Subscriptions.private\Remove-AzsSubscription_DeleteViaIdentity';
        }
...
.Link
https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions/set-azssubscription
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Update = 'Azs.Subscriptions.private\Set-AzsSubscription_Update';
            UpdateExpanded = 'Azs.Subscriptions.private\Set-AzsSubscription_UpdateExpanded';
        }
