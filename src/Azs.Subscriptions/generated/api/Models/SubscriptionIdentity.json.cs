...
namespace Microsoft.Azure.PowerShell.Cmdlets.Subscription.Models
{
    ...
    public partial class SubscriptionIdentity
    {
        ...
        internal SubscriptionIdentity(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject json)
        {
            ...
            {_delegatedProviderId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString>("delegatedProviderId"), out var __jsonDelegatedProviderId) ? (string)__jsonDelegatedProviderId : (string)DelegatedProviderId;}
            {_offerName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString>("offerName"), out var __jsonOfferName) ? (string)__jsonOfferName : (string)OfferName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._delegatedProviderId)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString(this._delegatedProviderId.ToString()) : null, "delegatedProviderId" ,container.Add );
            AddIf( null != (((object)this._offerName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Subscription.Runtime.Json.JsonString(this._offerName.ToString()) : null, "offerName" ,container.Add );
