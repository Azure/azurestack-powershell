    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"Azs.Subscriptions.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft Azure PowerShell: User subscription cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Azs.Subscriptions.private.dll"}'");
      sb.AppendLine($@"{Indent}RequiredModules = @(@{{ModuleName = 'Az.Accounts'; RequiredVersion = '2.2.8'; }}, @{{ModuleName = 'Az.Resources'; RequiredVersion = '0.11.0'; }})");
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Azs.Subscriptions.format.ps1xml").ToPsList();
                ...
                sb.AppendLine($@"{Indent}{Indent}{Indent}Tags = {"Azure ResourceManager ARM PSModule".Split(' ').ToPsList().NullIfEmpty() ?? "''"}");
