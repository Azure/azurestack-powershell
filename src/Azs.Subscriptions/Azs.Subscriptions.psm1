# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Azs.Subscriptions.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Azs.Subscriptions.custom.psm1'
