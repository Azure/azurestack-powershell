...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Support";
