...
using Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
