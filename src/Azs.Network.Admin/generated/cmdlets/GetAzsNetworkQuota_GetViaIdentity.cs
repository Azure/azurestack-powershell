...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/locations/{location}/quotas/{resourceName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsNetworkQuota_GetViaIdentity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Description(@"Get a quota by name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Generated]
    public partial class GetAzsNetworkQuota_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzsNetworkQuota_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzsNetworkQuota_GetViaIdentity()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        await this.Client.QuotasGet(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, InputObject.ResourceName ?? null, onOk, this, Pipeline);
                    }
