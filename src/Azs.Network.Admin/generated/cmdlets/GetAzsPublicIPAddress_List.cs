...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/adminPublicIpAddresses"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsPublicIPAddress_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IPublicIPAddress))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Description(@"List of public IP addresses.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Generated]
    public partial class GetAzsPublicIPAddress_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener
    {
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Query)]
        ...
        /// <summary>Backing field for <see cref="InlineCount" /> property.</summary>
        private string _inlineCount;

        /// <summary>OData inline count parameter.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "OData inline count parameter.")]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Query)]
        public string InlineCount { get => this._inlineCount; set => this._inlineCount = value; }
        ...
        /// <summary>OData orderBy parameter.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "OData orderBy parameter.")]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IPublicIPAddressList"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IPublicIPAddressList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzsPublicIPAddress_List" /> cmdlet class.
        /// </summary>
        public GetAzsPublicIPAddress_List()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IPublicIPAddressList> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    ...
                    {
                        requestMessage = requestMessage.Clone(new global::System.Uri( result.NextLink ),Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Method.Get );
                        await ((Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                        await this.Client.PublicIPAddressesList_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
