...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Delete=>DELETE:"/subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/locations/{location}/quotas/{resourceName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzsNetworkQuota_DeleteViaIdentity", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Description(@"Delete a quota by name.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Generated]
    public partial class RemoveAzsNetworkQuota_DeleteViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of RemoveAzsNetworkQuota_DeleteViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Cmdlets.RemoveAzsNetworkQuota_DeleteViaIdentity Clone()
        {
            var clone = new RemoveAzsNetworkQuota_DeleteViaIdentity();
         ...
         async global::System.Threading.Tasks.Task Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener.Signal(string id, global::System.Threading.CancellationToken token, global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.EventData> messageData)
        {
            using( NoSynchronizationContext )
            {
                ...
                switch ( id )
                {
                    ...
                    case Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Events.DelayBeforePolling:
                    {
                        if (true == MyInvocation?.BoundParameters?.ContainsKey("NoWait"))
                        {
                            ...
                            if (data.ResponseMessage is System.Net.Http.HttpResponseMessage response)
                            {
                                ...
                                WriteObject(new Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.PowerShell.AsyncOperationResponse { Target = uri });
                                // do nothing more.
                                data.Cancel();
                                return;
                            }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'QuotasDelete' operation"))
                {
                    if (true == MyInvocation?.BoundParameters?.ContainsKey("AsJob"))
                    {
                        var instance = this.Clone();
                        var job = new Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.PowerShell.AsyncJob(instance, this.MyInvocation.Line, this.MyInvocation.MyCommand.Name, this._cancellationTokenSource.Token, this._cancellationTokenSource.Cancel);
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.QuotasDeleteViaIdentity(InputObject.Id, onOk, onNoContent, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.QuotasDelete(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, InputObject.ResourceName ?? null, onOk, onNoContent, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzsNetworkQuota_DeleteViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzsNetworkQuota_DeleteViaIdentity()
        {
