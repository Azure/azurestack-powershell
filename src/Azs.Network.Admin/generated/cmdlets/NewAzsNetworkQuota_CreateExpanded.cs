...
namespace Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzsNetworkQuota_CreateExpanded", SupportsShouldProcess = true)]
    ...
    public partial class NewAzsNetworkQuota_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of load balancers a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"50")]
        public long MaxLoadBalancersPerSubscription { get => QuotaBody.MaxLoadBalancersPerSubscription ?? default(long); set => QuotaBody.MaxLoadBalancersPerSubscription = value; }

        /// <summary>Maximum number of NICs a tenant subscription can provision.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of NICs a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"100")]
        public long MaxNicsPerSubscription { get => QuotaBody.MaxNicsPerSubscription ?? default(long); set => QuotaBody.MaxNicsPerSubscription = value; }

        /// <summary>Maximum number of public IP addresses a tenant subscription can provision.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of public IP addresses a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"50")]
        public long MaxPublicIpsPerSubscription { get => QuotaBody.MaxPublicIpsPerSubscription ?? default(long); set => QuotaBody.MaxPublicIpsPerSubscription = value; }

        /// <summary>Maximum number of security groups a tenant subscription can provision.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of security groups a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"50")]
        public long MaxSecurityGroupsPerSubscription { get => QuotaBody.MaxSecurityGroupsPerSubscription ?? default(long); set => QuotaBody.MaxSecurityGroupsPerSubscription = value; }

        /// <summary>
        /// Maximum number of virtual network gateway Connections a tenant subscription can provision.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of virtual network gateway Connections a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"2")]
        public long MaxVirtualNetworkGatewayConnectionsPerSubscription { get => QuotaBody.MaxVirtualNetworkGatewayConnectionsPerSubscription ?? default(long); set => QuotaBody.MaxVirtualNetworkGatewayConnectionsPerSubscription = value; }

        /// <summary>Maximum number of virtual network gateways a tenant subscription can provision.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of virtual network gateways a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"1")]
        public long MaxVirtualNetworkGatewaysPerSubscription { get => QuotaBody.MaxVirtualNetworkGatewaysPerSubscription ?? default(long); set => QuotaBody.MaxVirtualNetworkGatewaysPerSubscription = value; }

        /// <summary>Maximum number of virtual networks a tenant subscription can provision.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of virtual networks a tenant subscription can provision.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"50")]
        public long MaxVnetsPerSubscription { get => QuotaBody.MaxVnetsPerSubscription ?? default(long); set => QuotaBody.MaxVnetsPerSubscription = value; }
        ...
        /// <summary>Backing field for <see cref="QuotaBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IQuota _quotaBody= new Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.Quota();

        /// <summary>Network quota resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IQuota QuotaBody { get => this._quotaBody; set => this._quotaBody = value; }
        ...
        [global::Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.ExportAs(typeof(global::System.Collections.Hashtable))]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.NetworkAdmin.Models.Api20150615.IResourceTags Tag { get => QuotaBody.Tag ?? null /* object */; set => QuotaBody.Tag = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzsNetworkQuota_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzsNetworkQuota_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.QuotasCreateOrUpdate(SubscriptionId, Location, Name, QuotaBody, onOk, onCreated, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,Name=Name,body=QuotaBody})
                    {
