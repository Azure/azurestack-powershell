...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Azs.Network.Admin.private\Get-AzsNetworkQuota_Get';
            GetViaIdentity = 'Azs.Network.Admin.private\Get-AzsNetworkQuota_GetViaIdentity';
            List = 'Azs.Network.Admin.private\Get-AzsNetworkQuota_List';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Create = 'Azs.Network.Admin.private\New-AzsNetworkQuota_Create';
            CreateExpanded = 'Azs.Network.Admin.private\New-AzsNetworkQuota_CreateExpanded';
        }
