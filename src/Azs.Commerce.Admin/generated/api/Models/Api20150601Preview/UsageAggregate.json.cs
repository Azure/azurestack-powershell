namespace Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview
{
    ...
    public partial class UsageAggregate
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview.IUsageAggregate.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview.IUsageAggregate.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview.IUsageAggregate FromJson(Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonObject json ? new UsageAggregate(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UsageAggregate" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UsageAggregate" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._property ? (Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonNode) this._property.ToJson(null,serializationMode) : null, "properties" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonObject into a new instance of <see cref="UsageAggregate" />.
        /// </summary>
        ...
        internal UsageAggregate(Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Models.Api20150601Preview.UsageAggregateModel.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }
    }
}