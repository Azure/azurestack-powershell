...
using Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.CommerceAdmin.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
