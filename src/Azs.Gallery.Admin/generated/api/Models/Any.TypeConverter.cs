...
namespace Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Models
{
    ...
    public partial class AnyTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="Any" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Models.IAny ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Models.IAny).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
