...
namespace Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Support";
