...
using static Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.PowerShell.PsHelpers;
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"Azs.Gallery.Admin.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft AzureStack PowerShell: Gallery Admin cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Azs.Gallery.Admin.private.dll"}'");
      sb.AppendLine($@"{Indent}RequiredModules = @(@{{ModuleName = 'Az.Accounts'; RequiredVersion = '2.2.8'; }}, @{{ModuleName = 'Az.Resources'; RequiredVersion = '0.11.0'; }})");
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Azs.Gallery.Admin.format.ps1xml").ToPsList();
