...
namespace Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        internal AsyncOperationResponse(Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(Microsoft.Azure.PowerShell.Cmdlets.GalleryAdmin.Runtime.Json.JsonNode.Parse(jsonText));
