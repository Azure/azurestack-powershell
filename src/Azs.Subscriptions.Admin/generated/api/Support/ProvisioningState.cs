...
namespace Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support
{
    ...
    {
        /// <summary>The provisioning state is accepted, and indicates provisioning is ongoing.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState Accepted = @"Accepted";

        /// <summary>
        /// The provisioning state is failed, and indicates the data is potentially out-of-sync with third parties.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState Failed = @"Failed";

        /// <summary>The provisioning state is not specified.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState NotSpecified = @"NotSpecified";

        /// <summary>
        /// The provisioning state is succeeded, and indicates the data is in-sync with third-parties.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
