...
namespace Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json
{
    ...
    {
        internal override object ToValue() => Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
