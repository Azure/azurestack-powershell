...
param(
    ...
    process {
        ...
        # PlanAcquisitionId is a required parameter while if AcquisitionId is not set, rest call fails with missing AcquisitionId property error
        if ($PSBoundParameters.ContainsKey(('PlanAcquisitionId')))
        {
            $PSBoundParameters['AcquisitionId'] = $PSBoundParameters['PlanAcquisitionId']
        }
