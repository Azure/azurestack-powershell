...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Azs.Compute.Admin.private\Get-AzsDisk_Get';
            GetViaIdentity = 'Azs.Compute.Admin.private\Get-AzsDisk_GetViaIdentity';
            List = 'Azs.Compute.Admin.private\Get-AzsDisk_List';
        }
