...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState Canceled = @"Canceled";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState Creating = @"Creating";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState Failed = @"Failed";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState Succeeded = @"Succeeded";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState e1, Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.ProvisioningState e2)
        {
            return !e2.Equals(e1);
        }
