...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzsVMExtension_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzsVMExtension_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IVMExtensionParameters _extension;

        /// <summary>Parameters used to create a new Virtual Machine Extension Image.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters used to create a new Virtual Machine Extension Image.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IVMExtensionParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IVMExtensionParameters Extension { get => this._extension; set => this._extension = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzsVMExtension_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzsVMExtension_CreateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.VMExtensionsCreateViaIdentity(InputObject.Id, Extension, onOk, onCreated, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.VMExtensionsCreate(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, InputObject.Publisher ?? null, InputObject.Type ?? null, InputObject.Version ?? null, Extension, onOk, onCreated, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=Extension})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Extension })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=Extension })
                    {
