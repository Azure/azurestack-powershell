...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzsGlobalFeatureSetting_Update", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzsGlobalFeatureSetting_Update : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Higher-priority global feature flags.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Higher-priority global feature flags.",
        SerializedName = @"globalFeatureSettings",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.IGlobalFeatureSettings) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.IGlobalFeatureSettings GlobalFeatureSetting { get => this._globalFeatureSetting; set => this._globalFeatureSetting = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateGlobalFeatureSettings(SubscriptionId, Location, FeatureName, GlobalFeatureSetting, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,FeatureName=FeatureName,body=GlobalFeatureSetting})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzsGlobalFeatureSetting_Update" /> cmdlet class.
        /// </summary>
        public UpdateAzsGlobalFeatureSetting_Update()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=GlobalFeatureSetting })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=GlobalFeatureSetting })
                    {
