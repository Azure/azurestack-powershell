...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/quotas/{quotaName}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzsComputeQuota_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Creates or Updates a Compute Quota with the provided quota parameters.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class NewAzsComputeQuota_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of availability sets allowed.")]
        ...
        Description =@"",
        Script = @"10")]
        public int AvailabilitySetCount { get => NewQuotaBody.AvailabilitySetCount ?? default(int); set => NewQuotaBody.AvailabilitySetCount = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of cores allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"100")]
        [global::System.Management.Automation.Alias("CoresLimit")]
        public int CoresCount { get => NewQuotaBody.CoresLimit ?? default(int); set => NewQuotaBody.CoresLimit = value; }

        /// <summary>Maximum number of dda gpus allowed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of dda gpus allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int DdagpuCount { get => NewQuotaBody.DdagpuCount ?? default(int); set => NewQuotaBody.DdagpuCount = value; }
        ...
        SerializedName = @"location",
        PossibleTypes = new [] { typeof(string) })]
        public string Location1 { get => NewQuotaBody.Location ?? null; set => NewQuotaBody.Location = value; }
        ...
        /// <summary>Backing field for <see cref="NewQuotaBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota _newQuotaBody= new Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.Quota();

        /// <summary>Holds Compute quota information used to control resource allocation.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota NewQuotaBody { get => this._newQuotaBody; set => this._newQuotaBody = value; }

        /// <summary>Maximum number of partitioned gpus allowed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of partitioned gpus allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int PartitionedGpuCount { get => NewQuotaBody.PartitionedGpuCount ?? default(int); set => NewQuotaBody.PartitionedGpuCount = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of managed disks and snapshots of type premium allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"2048")]
        public int PremiumManagedDiskAndSnapshotSize { get => NewQuotaBody.PremiumManagedDiskAndSnapshotSize ?? default(int); set => NewQuotaBody.PremiumManagedDiskAndSnapshotSize = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of managed disks and snapshots of type standard allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"2048")]
        public int StandardManagedDiskAndSnapshotSize { get => NewQuotaBody.StandardManagedDiskAndSnapshotSize ?? default(int); set => NewQuotaBody.StandardManagedDiskAndSnapshotSize = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of scale sets allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(int) })]
        public int VMScaleSetCount { get => NewQuotaBody.VMScaleSetCount ?? default(int); set => NewQuotaBody.VMScaleSetCount = value; }

        /// <summary>Maximum number of virtual machines allowed.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Maximum number of virtual machines allowed.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Description =@"",
        Script = @"100")]
        public int VirtualMachineCount { get => NewQuotaBody.VirtualMachineCount ?? default(int); set => NewQuotaBody.VirtualMachineCount = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzsComputeQuota_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzsComputeQuota_CreateExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.QuotasCreateOrUpdate(SubscriptionId, Location, Name, NewQuotaBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,Name=Name,body=NewQuotaBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, Name=Name, body=NewQuotaBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, Name=Name, body=NewQuotaBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota
