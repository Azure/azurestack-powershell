...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzsComputeQuota_Create", SupportsShouldProcess = true)]
    ...
    public partial class NewAzsComputeQuota_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota _newQuota;

        /// <summary>Holds Compute quota information used to control resource allocation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Holds Compute quota information used to control resource allocation.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api202101.IQuota NewQuota { get => this._newQuota; set => this._newQuota = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzsComputeQuota_Create" /> cmdlet class.
        /// </summary>
        public NewAzsComputeQuota_Create()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.QuotasCreateOrUpdate(SubscriptionId, Location, Name, NewQuota, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,Name=Name,body=NewQuota})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, Name=Name, body=NewQuota })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, Name=Name, body=NewQuota })
                    {
