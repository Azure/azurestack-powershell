...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] UpdateGlobalFeatureSettings=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/features/{featureName}/updateGlobalFeatureSettings"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzsGlobalFeatureSetting_UpdateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Update the feature settings.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class UpdateAzsGlobalFeatureSetting_UpdateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Name of the feature.")]
        ...
        /// <summary>Backing field for <see cref="GlobalFeatureSettingsBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.IGlobalFeatureSettings _globalFeatureSettingsBody= new Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.GlobalFeatureSettings();

        /// <summary>Higher-priority global feature flags.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.IGlobalFeatureSettings GlobalFeatureSettingsBody { get => this._globalFeatureSettingsBody; set => this._globalFeatureSettingsBody = value; }

        /// <summary>The state of the global feature.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The state of the global feature.")]
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.GlobalFeatureState))]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.GlobalFeatureState GlobalFeatureState { get => GlobalFeatureSettingsBody.GlobalFeatureState ?? ((Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Support.GlobalFeatureState)""); set => GlobalFeatureSettingsBody.GlobalFeatureState = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'UpdateGlobalFeatureSettings' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.UpdateGlobalFeatureSettings(SubscriptionId, Location, FeatureName, GlobalFeatureSettingsBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,FeatureName=FeatureName,body=GlobalFeatureSettingsBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzsGlobalFeatureSetting_UpdateExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzsGlobalFeatureSetting_UpdateExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=GlobalFeatureSettingsBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=GlobalFeatureSettingsBody })
                    {
