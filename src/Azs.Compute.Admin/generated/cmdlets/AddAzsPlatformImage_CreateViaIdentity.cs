...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzsPlatformImage_CreateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzsPlatformImage_CreateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="NewImage" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IPlatformImageParameters _newImage;

        /// <summary>Parameters used to create a new platform image.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters used to create a new platform image.", ValueFromPipeline = true)]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IPlatformImageParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.IPlatformImageParameters NewImage { get => this._newImage; set => this._newImage = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzsPlatformImage_CreateViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzsPlatformImage_CreateViaIdentity()
        {
        ...
        /// <returns>a duplicate instance of AddAzsPlatformImage_CreateViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets.AddAzsPlatformImage_CreateViaIdentity Clone()
        {
            var clone = new AddAzsPlatformImage_CreateViaIdentity();
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.PlatformImagesCreateViaIdentity(InputObject.Id, NewImage, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.PlatformImagesCreate(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, InputObject.Publisher ?? null, InputObject.Offer ?? null, InputObject.Sku ?? null, InputObject.Version ?? null, NewImage, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=NewImage})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=NewImage })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=NewImage })
                    {
