...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] List=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/disks"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsDisk_List")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Returns a list of disks.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class GetAzsDisk_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>The maximum number of disks to return.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The maximum number of disks to return.")]
        ...
        /// <summary>The scale unit which the resource belongs to.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The scale unit which the resource belongs to.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>The share which the resource belongs to.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The share which the resource belongs to.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>The start index of disks in query.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The start index of disks in query.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>The parameters of disk state.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The parameters of disk state.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="UserSubscriptionId" /> property.</summary>
        private string _userSubscriptionId;

        /// <summary>User Subscription Id which the resource belongs to.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "User Subscription Id which the resource belongs to.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Query)]
        public string UserSubscriptionId { get => this._userSubscriptionId; set => this._userSubscriptionId = value; }

        /// <summary>Backing field for <see cref="VolumeLabel" /> property.</summary>
        private string _volumeLabel;

        /// <summary>The volume label of the volume which the resource belongs to.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The volume label of the volume which the resource belongs to.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskList"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskList> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>Intializes a new instance of the <see cref="GetAzsDisk_List" /> cmdlet class.</summary>
        public GetAzsDisk_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DisksList(SubscriptionId, Location, this.InvocationInformation.BoundParameters.ContainsKey("UserSubscriptionId") ? UserSubscriptionId : null, this.InvocationInformation.BoundParameters.ContainsKey("Status") ? Status : null, this.InvocationInformation.BoundParameters.ContainsKey("SharePath") ? SharePath : null, this.InvocationInformation.BoundParameters.ContainsKey("ScaleUnit") ? ScaleUnit : null, this.InvocationInformation.BoundParameters.ContainsKey("VolumeLabel") ? VolumeLabel : null, this.InvocationInformation.BoundParameters.ContainsKey("Count") ? Count : default(int?), this.InvocationInformation.BoundParameters.ContainsKey("Start") ? Start : default(int?), onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,UserSubscriptionId=this.InvocationInformation.BoundParameters.ContainsKey("UserSubscriptionId") ? UserSubscriptionId : null,Status=this.InvocationInformation.BoundParameters.ContainsKey("Status") ? Status : null,SharePath=this.InvocationInformation.BoundParameters.ContainsKey("SharePath") ? SharePath : null,ScaleUnit=this.InvocationInformation.BoundParameters.ContainsKey("ScaleUnit") ? ScaleUnit : null,VolumeLabel=this.InvocationInformation.BoundParameters.ContainsKey("VolumeLabel") ? VolumeLabel : null,Count=this.InvocationInformation.BoundParameters.ContainsKey("Count") ? Count : default(int?),Start=this.InvocationInformation.BoundParameters.ContainsKey("Start") ? Start : default(int?)})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskList> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
