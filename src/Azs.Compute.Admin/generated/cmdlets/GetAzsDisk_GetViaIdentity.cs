...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/disks/{diskId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzsDisk_GetViaIdentity")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Returns the disk.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class GetAzsDisk_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ShowSizeDetail" /> property.</summary>
        private global::System.Management.Automation.SwitchParameter _showSizeDetail;

        /// <summary>Switch for whether summary or detailed disk size information is returned.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Switch for whether summary or detailed disk size information is returned.")]
        ...
        public global::System.Management.Automation.SwitchParameter ShowSizeDetail { get => this._showSizeDetail; set => this._showSizeDetail = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzsDisk_GetViaIdentity" /> cmdlet class.
        /// </summary>
        public GetAzsDisk_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DisksGetViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("ShowSizeDetail") ? ShowSizeDetail : default(global::System.Management.Automation.SwitchParameter?), onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.DiskId)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.DiskId"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        await this.Client.DisksGet(InputObject.SubscriptionId ?? null, InputObject.Location ?? null, InputObject.DiskId ?? null, this.InvocationInformation.BoundParameters.ContainsKey("ShowSizeDetail") ? ShowSizeDetail : default(global::System.Management.Automation.SwitchParameter?), onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ShowSizeDetail=this.InvocationInformation.BoundParameters.ContainsKey("ShowSizeDetail") ? ShowSizeDetail : default(global::System.Management.Automation.SwitchParameter?)})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ShowSizeDetail=this.InvocationInformation.BoundParameters.ContainsKey("ShowSizeDetail") ? ShowSizeDetail : default(global::System.Management.Automation.SwitchParameter?) })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ShowSizeDetail=this.InvocationInformation.BoundParameters.ContainsKey("ShowSizeDetail") ? ShowSizeDetail : default(global::System.Management.Automation.SwitchParameter?) })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk
