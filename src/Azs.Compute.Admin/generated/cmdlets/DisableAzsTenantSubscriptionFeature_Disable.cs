...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] DisableTenantSubscriptionFeature=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/features/{featureName}/disableTenantSubscriptionFeature"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Disable, @"AzsTenantSubscriptionFeature_Disable", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Disable the tenant subscription feature.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class DisableAzsTenantSubscriptionFeature_Disable : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="TenantSubscriptionFeatureSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.ITenantSubscriptionFeatureSettings _tenantSubscriptionFeatureSetting;

        /// <summary>The feature settings for the tenant subscription.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The feature settings for the tenant subscription.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The feature settings for the tenant subscription.",
        SerializedName = @"tenantSubscriptionFeatureSettings",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.ITenantSubscriptionFeatureSettings) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20201101.ITenantSubscriptionFeatureSettings TenantSubscriptionFeatureSetting { get => this._tenantSubscriptionFeatureSetting; set => this._tenantSubscriptionFeatureSetting = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="DisableAzsTenantSubscriptionFeature_Disable" /> cmdlet class.
        /// </summary>
        public DisableAzsTenantSubscriptionFeature_Disable()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DisableTenantSubscriptionFeature' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DisableTenantSubscriptionFeature(SubscriptionId, Location, FeatureName, TenantSubscriptionFeatureSetting, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,FeatureName=FeatureName,body=TenantSubscriptionFeatureSetting})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20151201Preview.ICrpErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=TenantSubscriptionFeatureSetting })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, FeatureName=FeatureName, body=TenantSubscriptionFeatureSetting })
                    {
