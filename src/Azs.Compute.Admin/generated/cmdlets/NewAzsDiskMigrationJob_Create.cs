...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/providers/Microsoft.Compute.Admin/locations/{location}/diskmigrationjobs/{migrationId}"
    /// </remarks>
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.InternalExport]
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzsDiskMigrationJob_Create", SupportsShouldProcess = true)]
    [global::System.Management.Automation.Alias("Start-AzsDiskMigrationJob")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskMigrationJob))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Description(@"Create a disk migration job.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Generated]
    public partial class NewAzsDiskMigrationJob_Create : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk[] _disks;

        /// <summary>List of disks.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "List of disks.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDisk[] Disks { get => this._disks; set => this._disks = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The migration job guid name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("MigrationId")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Path)]
        ...
        /// <summary>Backing field for <see cref="TargetScaleUnit" /> property.</summary>
        private string _targetScaleUnit;

        /// <summary>The target scale unit name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The target scale unit name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Query)]
        public string TargetScaleUnit { get => this._targetScaleUnit; set => this._targetScaleUnit = value; }

        /// <summary>Backing field for <see cref="TargetShare" /> property.</summary>
        private string _targetShare;

        /// <summary>The target share name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The target share name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Query)]
        public string TargetShare { get => this._targetShare; set => this._targetShare = value; }

        /// <summary>Backing field for <see cref="TargetVolumeLabel" /> property.</summary>
        private string _targetVolumeLabel;

        /// <summary>The target volume label.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The target volume label.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.ParameterCategory.Query)]
        public string TargetVolumeLabel { get => this._targetVolumeLabel; set => this._targetVolumeLabel = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IErrorResponse"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onDefault method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IErrorResponse> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskMigrationJob"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskMigrationJob> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzsDiskMigrationJob_Create" /> cmdlet class.
        /// </summary>
        public NewAzsDiskMigrationJob_Create()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DiskMigrationJobsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DiskMigrationJobsCreate(SubscriptionId, Location, Name, this.InvocationInformation.BoundParameters.ContainsKey("TargetShare") ? TargetShare : null, this.InvocationInformation.BoundParameters.ContainsKey("TargetScaleUnit") ? TargetScaleUnit : null, this.InvocationInformation.BoundParameters.ContainsKey("TargetVolumeLabel") ? TargetVolumeLabel : null, Disks, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,Name=Name,TargetShare=this.InvocationInformation.BoundParameters.ContainsKey("TargetShare") ? TargetShare : null,TargetScaleUnit=this.InvocationInformation.BoundParameters.ContainsKey("TargetScaleUnit") ? TargetScaleUnit : null,TargetVolumeLabel=this.InvocationInformation.BoundParameters.ContainsKey("TargetVolumeLabel") ? TargetVolumeLabel : null,body=Disks})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    var ex = new Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Runtime.RestException<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IErrorResponse>(responseMessage, await response);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskMigrationJob> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ComputeAdmin.Models.Api20210401.IDiskMigrationJob
