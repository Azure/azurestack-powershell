...
using static Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Runtime.PowerShell.PsProxyOutputExtensions;
using static Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Runtime.PowerShell.PsProxyTypeExtensions;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Runtime.PowerShell
{
    ...
    internal class BeginOutput
    {
        ...
        {
            return VariantGroup.IsInternal ? "" : $@"{Indent}{Indent}$cmdInfo = Get-Command -Name $mapping[$parameterSet]{Environment.NewLine}{Indent}{Indent}[Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)";
        }
