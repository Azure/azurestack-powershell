...
namespace Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Runtime.PowerShell
{
  ...
  public class ExportModelSurface : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.KeyvaultAdmin.Support";
