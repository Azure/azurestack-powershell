...
.Link
https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/get-azsstorageacquisition
#>
function Get-AzsStorageAcquisition {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Models.Api201908Preview.IAcquisition])]
[CmdletBinding(DefaultParameterSetName='List', PositionalBinding=$false)]
param(
    [Parameter()]
    [Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Category('Path')]
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            List = 'Azs.Storage.Admin.private\Get-AzsStorageAcquisition_List';
        }
...
.Link
https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/get-azsstoragesettings
#>
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Get = 'Azs.Storage.Admin.private\Get-AzsStorageSettings_Get';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            CreateExpanded = 'Azs.Storage.Admin.custom\New-AzsStorageQuota';
            Create = 'Azs.Storage.Admin.custom\New-AzsStorageQuota';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Delete = 'Azs.Storage.Admin.custom\Remove-AzsStorageQuota';
            DeleteViaIdentity = 'Azs.Storage.Admin.custom\Remove-AzsStorageQuota';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Name = 'Azs.Storage.Admin.custom\Set-AzsStorageQuota';
            QuotaObject = 'Azs.Storage.Admin.custom\Set-AzsStorageQuota';
        }
        if (('Name', 'QuotaObject') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('Location')) {
            $PSBoundParameters['Location'] = (Get-AzLocation)[0].Location
        }
        if (('Name', 'QuotaObject') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
        $cmdInfo = Get-Command -Name $mapping[$parameterSet]
        [Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Runtime.MessageAttributeHelper]::ProcessCustomAttributesAtRuntime($cmdInfo, $MyInvocation, $parameterSet, $PSCmdlet)
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            UpdateExpanded = 'Azs.Storage.Admin.custom\Set-AzsStorageSettings';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Reclaim = 'Azs.Storage.Admin.custom\Start-AzsReclaimStorageCapacity';
        }
