 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Runtime.Json
{
    using System;
    ...
    {
        internal override object ToValue() => Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
