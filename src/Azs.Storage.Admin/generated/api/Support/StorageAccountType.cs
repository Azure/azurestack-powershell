...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType PremiumLrs = @"Premium_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType StandardGrs = @"Standard_GRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType StandardLrs = @"Standard_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType StandardRagrs = @"Standard_RAGRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType StandardZrs = @"Standard_ZRS";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType e1, Microsoft.Azure.PowerShell.Cmdlets.StorageAdmin.Support.StorageAccountType e2)
        {
            return !e2.Equals(e1);
        }
