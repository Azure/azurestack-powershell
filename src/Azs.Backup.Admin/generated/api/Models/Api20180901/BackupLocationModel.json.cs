namespace Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901
{
    ...
    public partial class BackupLocationModel
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject into a new instance of <see cref="BackupLocationModel" />.
        /// </summary>
        ...
        internal BackupLocationModel(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject json)
        {
            ...
            {_externalStoreDefault = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject>("externalStoreDefault"), out var __jsonExternalStoreDefault) ? Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.ExternalStore.FromJson(__jsonExternalStoreDefault) : ExternalStoreDefault;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocationModel.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocationModel.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocationModel FromJson(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject json ? new BackupLocationModel(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BackupLocationModel" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BackupLocationModel" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._externalStoreDefault ? (Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode) this._externalStoreDefault.ToJson(null,serializationMode) : null, "externalStoreDefault" ,container.Add );
