namespace Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901
{
    ...
    public partial class BackupLocation
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject into a new instance of <see cref="BackupLocation" />.
        /// </summary>
        ...
        internal BackupLocation(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.BackupLocationModel.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models.Api20180901.IBackupLocation FromJson(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject json ? new BackupLocation(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="BackupLocation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="BackupLocation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._property ? (Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json.JsonNode) this._property.ToJson(null,serializationMode) : null, "properties" ,container.Add );
