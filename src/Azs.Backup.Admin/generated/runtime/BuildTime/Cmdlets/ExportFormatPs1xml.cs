...
namespace Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Support";
