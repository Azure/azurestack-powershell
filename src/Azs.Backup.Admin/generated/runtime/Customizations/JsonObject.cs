 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.Json
{
    using System;
    ...
    {
        internal override object ToValue() => Microsoft.Azure.PowerShell.Cmdlets.BackupAdmin.Runtime.JsonSerializable.FromJson(this, new System.Collections.Generic.Dictionary<string, object>(), (obj) => obj.ToValue());
