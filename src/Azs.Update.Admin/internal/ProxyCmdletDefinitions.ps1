...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Azs.Update.Admin.private\Get-AzsUpdateRun_Get';
            GetViaIdentity = 'Azs.Update.Admin.private\Get-AzsUpdateRun_GetViaIdentity';
            List = 'Azs.Update.Admin.private\Get-AzsUpdateRun_List';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Apply = 'Azs.Update.Admin.private\Install-AzsUpdate_Apply';
            ApplyViaIdentity = 'Azs.Update.Admin.private\Install-AzsUpdate_ApplyViaIdentity';
        }
...
begin {
    try {
        ...
        $parameterSet = $PSCmdlet.ParameterSetName
        $mapping = @{
            Rerun = 'Azs.Update.Admin.private\Resume-AzsUpdateRun_Rerun';
            RerunViaIdentity = 'Azs.Update.Admin.private\Resume-AzsUpdateRun_RerunViaIdentity';
        }
