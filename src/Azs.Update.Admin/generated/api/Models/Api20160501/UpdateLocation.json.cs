namespace Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501
{
    ...
    public partial class UpdateLocation
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateLocation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateLocation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.IUpdateLocation FromJson(Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonObject json ? new UpdateLocation(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="UpdateLocation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateLocation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._property ? (Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonNode) this._property.ToJson(null,serializationMode) : null, "properties" ,container.Add );
            AfterToJson(ref container);
            return container;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonObject into a new instance of <see cref="UpdateLocation" />.
        /// </summary>
        ...
        internal UpdateLocation(Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonObject json)
        {
            bool returnNow = false;
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Models.Api20160501.UpdateLocationModel.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }
    }
}