...
using Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
