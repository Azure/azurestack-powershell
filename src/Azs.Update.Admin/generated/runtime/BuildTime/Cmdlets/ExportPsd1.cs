...
using static Microsoft.Azure.PowerShell.Cmdlets.UpdateAdmin.Runtime.PowerShell.PsHelpers;
    ...
    public class ExportPsd1 : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                sb.AppendLine($@"{Indent}RootModule = '{"Azs.Update.Admin.psm1"}'");
                ...
                sb.AppendLine($@"{Indent}Description = '{"Microsoft AzureStack PowerShell: Update Admin cmdlets"}'");
                ...
                {
                    sb.AppendLine($@"{Indent}RequiredAssemblies = '{"./bin/Azs.Update.Admin.private.dll"}'");
      sb.AppendLine($@"{Indent}RequiredModules = @(@{{ModuleName = 'Az.Accounts'; RequiredVersion = '2.2.8'; }}, @{{ModuleName = 'Az.Resources'; RequiredVersion = '0.11.0'; }})");
                ...
                else
                {
                    ...
                    var formatList = customFormatPs1xmlFiles.Prepend("./Azs.Update.Admin.format.ps1xml").ToPsList();
